...
const properties = [
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/2988860/pexels-photo-2988860.jpeg?auto=compress&cs=tinysrgb&w=400",
    beds: 2,
    baths: 2,
    area: "1200 sq ft",
    rating: 4.6,
...
const getTagColor = (tag: string) => {
  switch (tag) {
    ...
    case 'HOT DEAL': return 'bg-red-100 text-red-800 border-red-200';
    case 'NEW LAUNCH': return 'bg-green-100 text-green-800 border-green-200';
    case 'AFFORDABLE': return 'bg-blue-100 text-blue-800 border-blue-200';
    case 'LUXURY': return 'bg-yellow-100 text-yellow-800 border-yellow-200';
    case 'FAMILY FRIENDLY': return 'bg-pink-100 text-pink-800 border-pink-200';
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                  <Badge className={`${getTagColor(property.tag)} border font-medium`}>
                    {property.tag}
                  </Badge>
                  <div className="flex space-x-2">
                    <div className="bg-black/50 backdrop-blur-sm rounded-full p-2 flex items-center space-x-1">
                      <Camera className="w-4 h-4 text-white" />
                      <span className="text-white text-xs font-medium">{property.photos}</span>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"

...
export default function EditorialSection({ posts, title, subtitle }: EditorialSectionProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-gray-100 to-gray-200 px-6 py-3 rounded-full mb-8">
            ...
            <span className="text-gray-700 font-semibold text-sm tracking-wider uppercase">Editorial Excellence</span>
          </div>
        ...
        <div className="space-y-24">
          {posts.map((post, index) => (
            <article key={post.id} className="group">
              <div className={`grid grid-cols-1 lg:grid-cols-12 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                {/* Image Section */}
                ...
                {/* Content Section */}
                <div className={`lg:col-span-5 space-y-8 ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                  {/* Meta Information */}

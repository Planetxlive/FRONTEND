              ...
              >
                <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${insight.color} opacity-80 group-hover:opacity-70 transition-opacity duration-300`}
                    ></div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {tools.map((tool, index) => (
              ...
              >
                <div
                  className={`p-6 rounded-2xl border-2 ${tool.color} hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1`}
                >
        ...
        <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-blue-800 rounded-3xl p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-purple-600 px-8 py-3 rounded-full font-semibold transition-all duration-300"
              >
                Talk to Expert
              </Button>
            </div>
